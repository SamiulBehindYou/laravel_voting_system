...
<main>
    ...
    <div id="slot-1" class="d-md-flex flex-md-equal w-100 my-md-3 ps-md-3">
      <div class="text-bg-dark me-md-3 pt-3 px-3 pt-md-5 px-md-5 text-center overflow-hidden">
        <div class="my-3 py-3">
          <h2 class="display-5">Vote heading 1</h2>
          <p class="lead">vote description 1</p>
        </div>
          ...
          <form action="" method="POST">
              ...
              <div class="mb-3 p-2">
                  ...
                  <select name="option" class="form-control" id="">
                      ...
                      <option value="2">jamrul</option>
                      <option value="3">johorul</option>
                      <option value="4">majharul</option>
                  </select>
              </div>
              <div class="mt-2">
